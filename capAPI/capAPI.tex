...
Per evitare duplicazione di codice, in particolare la presenza doppia degli erb dei template dei prodotti,
...
In questa classe viene implementato il meccanismo di composizione della chiamta, la lettura della risposta e la sostituzione 
...
dove viene definito quale rotta delle renderedAPI chimare e \emph{allowed\_api\_parameters} dove viene definita
